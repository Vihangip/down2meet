...
export const Post = ({ post }) => {
  ...
  const handleAddEvent = () => {    
    ...
    console.log(user.user_id === useruser.user_id);
    return (<>
      {user.user_id === useruser.user_id ? <div className="Post">
      <img className="Post-UserInfo-Image" src={user.picture ? user.picture : blankpic} alt="" />
       <div className="Post-Container">
         <div key={post.id} className="Post-UserInfo">
           <p className='Post-Username-Meactive'>{user.name}</p>
         </div>
         ...
         {user.availability === "Available"  ? 
           <div className="Post-Invite-Info">
             {post.time ? 
               <div className="Post-Invite-InfoContainer-Meactive">
         ...
         : 
         <div className="Post-Invite-Info">
         <div className="Post-Invite-InfoContainer-Meinactive">
           <i className="fa-regular fa-clock"></i>
           <p>{post.time}</p>
         </div>
         <div className="Post-Invite-InfoContainer-Meinactive">
